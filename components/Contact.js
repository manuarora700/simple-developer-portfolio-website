  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto h-48 bg-white dark:bg-gray-800 antialiased">
        <h1 className="text-[#F6E37D] text-9xl ">Contact</h1>
      </div>
      <div className="relative z-10 rounded-md shadow-md bg-[#073258] p-4 md:p-10 lg:p-20 max-w-6xl mx-auto mb-20 -mt-4">
