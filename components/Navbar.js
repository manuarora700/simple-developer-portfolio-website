    ...
    <div class="max-w-6xl  mx-auto px-4 py-10 md:py-20">
      <div class="flex  md:flex-row justify-between items-center">
        ...
        <div class="flex flex-col">
          <h1 class="font-semibold text-xl dark:text-gray-100">Manu Arora</h1>
        ...
        <div class="space-x-8 hidden md:block">
          <Link href="/about">
            <a class="text-base font-normal text-gray-600 dark:text-gray-300">
              About
            </a>
          </Link>
          <Link href="/work">
