...
export default function LatestCode() {
  return (
    <section class="bg-[#F1F1F1] -mt-40 dark:bg-gray-900 pb-40">
      <div class="max-w-6xl mx-auto">
        <div class="flex flex-col md:flex-row justify-between items-center md:pt-40 mx-10">
          <h1 class="text-6xl lg:text-9xl max-w-lg font-bold text-gray-500 my-20 md:my-0 md:text-white dark:text-gray-600 text-center lg:text-left">
            Latest Code
          </h1>

          <a
            href="https://github.com/manuarora700"
            class="mb-20 md:mb-0 px-8 py-4 rounded-md bg-white shadow-lg text-xl font-semibold flex flex-row space-x-4 items-center dark:text-gray-700"
          >
            <svg
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto px-10 lg:-mt-10 gap-y-20">
        {/* Single github Repo */}
        <div class="github-repo">
          <h1 class="font-semibold text-xl dark:text-gray-200 text-gray-700">
            Tailwind Starter Portfolio Project
          </h1>
          <p class="text-base font-normal my-4 text-gray-500">
